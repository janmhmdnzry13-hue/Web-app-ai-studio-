-- ============================================================================
-- ORIGIN RELATIONAL DATABASE SCHEMA (PostgreSQL)
-- ============================================================================
-- Source of Truth: Existing TypeScript Models, Repository Interfaces,
-- JSON Persistence Schema, and Zod Validation Contracts.
--
-- Multi-Tenant Security & Isolation:
-- Every user-owned entity strictly enforces:
--   1. Foreign key constraint REFERENCES users(id) ON DELETE CASCADE
--   2. Dedicated B-tree index on user_id for high-performance scoped queries
-- ============================================================================
...
-- ----------------------------------------------------------------------------
-- 13. RELATIONSHIP IMPORTANT DATES / ANNIVERSARIES
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 14. CONTACT INTERACTIONS (CRM Log)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 16. AI MEMORIES (Co-Pilot Long-Term Memory)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 17. AUDIT LOGS (Security & Compliance Trail)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 19. SCHEDULED NOTIFICATIONS (Server-Side Delivery Queue)
-- ----------------------------------------------------------------------------
...
-- ----------------------------------------------------------------------------
-- 20. NOTIFICATIONS (User In-App Inbox)
-- ----------------------------------------------------------------------------
