...
export const APP_CONSTANTS = Object.freeze({
  ...
  VERSION: '0.3.0',
  RELEASE_PHASE: 'Phase 3: Complete Life Management OS',
  STORAGE_KEYS: {
    ...
    TRANSACTIONS_PREFIX: 'origin_transactions_',
    BUDGETS_PREFIX: 'origin_budgets_',
    REFLECTIONS_PREFIX: 'origin_reflections_',
    RELATIONSHIPS_PREFIX: 'origin_relationships_',
    NOTES_PREFIX: 'origin_notes_',
    NOTE_FOLDERS_PREFIX: 'origin_note_folders_',
    NOTIFICATIONS_PREFIX: 'origin_notifications_',
    NOTIFICATION_SETTINGS_PREFIX: 'origin_notif_settings_',
    INSIGHTS_PREFIX: 'origin_insights_',
